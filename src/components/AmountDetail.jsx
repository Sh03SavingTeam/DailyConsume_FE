      ...
      <div className="amount-detail-content">
        ...
        <div className="detail-header">
          ...
          <div className="company-amount">
            <p>
              <strong>{detail?.company}</strong> {detail?.amount}원
            </p>
        ...
        <div className="details">
          ...
          <div className="detail-item">
            <strong>메모:</strong> {detail?.memo}
          </div>
          <div className="detail-item">
            <strong>결제 수단:</strong> {detail?.paymentMethod}
          </div>
          <div className="detail-item">
            <strong>결제 방법:</strong> {detail?.paymentType}
          </div>
          <div className="detail-item important">
            <strong>결제 일자:</strong> {detail?.paymentDate}
          </div>
          <div className="detail-item">
            <strong>결제 상품:</strong> {detail?.product}
          </div>
          <div className="detail-item">
            <strong>결제 장소:</strong> {detail?.location} {detail?.place}
          </div>
          <div className="detail-item total-amount">
            <strong>결제 금액:</strong> 총 {detail?.totalAmount}
          </div>
          <hr />
          <div className="detail-item weekly-budget">
            <strong>주간소비잔여금액:</strong> {detail?.remainingAmount}
          </div>
          {!isNormal && (
